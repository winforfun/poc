...
export class WFPlayer {
   ...
   */
  @Prop({ mutable: true, reflectToAttr: true }) favourite: boolean = false;
                  ...
                  <div class="mdc-card__actions">
                    <div class="mdc-card__action-buttons">
                      <button
                        ...
                        onClick={() => (this.favourite = !this.favourite)}
                        title={`${this.favourite ? "Remove from" : "Add to"} favorites`}
                        aria-pressed={String(!!this.favourite)}
                      >
                        <svg
